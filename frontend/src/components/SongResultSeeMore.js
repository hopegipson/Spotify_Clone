...
class SongResultSeeMore extends Component {
    ...
    renderSongs = () => this.props.songs.map((song, index) => <SongSeeMore key={index} index={index} song ={song} user={this.props.state.user} callPlayback={this.callPlayback} />) 
...
export default connect(mapStateToProps, mapDispatchToProps)(SongResultSeeMore)   